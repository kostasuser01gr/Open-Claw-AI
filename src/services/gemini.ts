...
export class GeminiService {
  ...
  async chat(
    ...
    const fullInstruction = `${baseInstruction}\n\n${config.systemInstruction || ""}\n\nIf you generate a document, code block, or structured data that should be edited or visualized, wrap it in <canvas type="document|code|data" title="Optional Title">...</canvas> tags. For type="data", the content MUST be a JSON object with a "data" array containing objects with "name" and "value" properties, and optionally a "chartType" property ("line", "bar", or "pie").`;
